...
//        System.out.println(Arrays.asList(stackTraceElements));

        // For Linux 8 For Windows 6
         int st = 5;
//        if (stackTraceElements[st].getClassName().equals("Salehi")) {
...
//			System.out.println("..........SALEHI..........");
            ...
            if ((temp1) - (temp2) == 0)
                ...
                return -1;
        } else if (Arrays.asList(stackTraceElements).toString().contains("proposedMothod")) {
...
//                return -1;
//            }
        } else if (Arrays.asList(stackTraceElements).toString().contains("Ansari2019")) {
            if (this.getWcet(0) - obj.getWcet(0) == 0)
                return 0;
            else if (this.getWcet(0) - obj.getWcet(0) > 0)
                return 1;
        ...
        else if (Arrays.asList(stackTraceElements).toString().contains("Medina"))
            return this.getLPL() - obj.getLPL();
        else if (Arrays.asList(stackTraceElements).toString().contains("MedinaReplication"))
            return this.getLPL() - obj.getLPL();
